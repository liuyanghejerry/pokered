...
pub static NPCS_AGATHASROOM: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x39,
    x: 5,
    y: 2,
...
pub static NPCS_BRUNOSROOM: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x3A,
    x: 5,
    y: 2,
    movement: NpcMovement(0),
...
pub static NPCS_CELADONMART1F: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x2A,
    x: 8,
    y: 3,
    movement: NpcMovement(0),
...
pub static NPCS_CERULEANBADGEHOUSE: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x0A,
    x: 5,
    y: 3,
    movement: NpcMovement(0),
...
pub static NPCS_CINNABARLAB: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x27,
    x: 1,
    y: 3,
    movement: NpcMovement(0),
...
pub static NPCS_COLOSSEUM: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x01,
    x: 2,
    y: 2,
    movement: NpcMovement(1),
...
pub static NPCS_DAYCARE: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x10,
    x: 2,
    y: 3,
    movement: NpcMovement(0),
...
pub static NPCS_DIGLETTSCAVEROUTE11: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x0B,
    x: 2,
    y: 3,
    movement: NpcMovement(0),
...
pub static NPCS_DIGLETTSCAVEROUTE2: [NpcEntry; 1] = [NpcEntry {
    sprite_id: 0x27,
    x: 3,
    y: 3,
    movement: NpcMovement(0),
